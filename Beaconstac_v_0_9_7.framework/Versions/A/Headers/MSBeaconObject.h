...
/**
 * Delegate to receive MSBeaconObject events
 */
@protocol MSBeaconObjectProtocol <NSObject>
 ...
 */
@interface MSBeaconObject : NSObject

@property (nonatomic) id<MSBeaconObjectProtocol> delegate;
