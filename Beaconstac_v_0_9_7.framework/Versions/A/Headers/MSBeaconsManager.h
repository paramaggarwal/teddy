 ...
 */
@protocol MSBeaconsManagerDelegate <NSObject>
 ...
 */
@interface MSBeaconsManager : NSObject<CLLocationManagerDelegate>

/**
 * Delegate to send events to.
 */
@property (nonatomic) id <MSBeaconsManagerDelegate> delegate;
